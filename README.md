...
<a href="https://github.com/telefonicaid/fiware-cygnus/blob/master/doc/devel/add_new_sink.md" target="_blank">Cygnus sink</a>
just like the <a href="https://github.com/telefonicaid/fiware-cygnus/tree/master/src/main/java/com/telefonica/iot/cygnus/sinks" target="_blank">other data stores</a> already supported by Cygnus.
...
### Consuming raw data <a id="section1.1"></a>
...
### Consuming aggregated time series information <a id="section1.2"></a>
...
### Updating aggregated time series information <a id="section1.3"></a>
...
* <a href="https://github.com/telefonicaid/fiware-cygnus/tree/master" href="_blank">Cygnus connector documentation</a>
* <a href="https://github.com/telefonicaid/fiware-cygnus/tree/master#section3.1" href="_blank">Orion subscription</a>
...
## Running the STH server <a id="section4"></a>
...
## Inserting data (random single events and its aggregated data) into the database <a id="section5"></a>
...
## STH component complete test coverage <a id="section6"></a> 
...
## Performance tests <a id="section7"></a>

The [Performance tests](test/perfomance/README.md) section of the repository includes information to run performance
...
## Additional resources <a id="section8"></a>
The [Additional resources](resources/README.md) section of the repository includes some scripts and utilities which may make the developer's life easier.
If you are interested on them, please navigate to that section of the repository for further information.

[Top](#section0)

## How to contribute <a id="section9"></a>
...
```no-highlight
git clone https://github.com/your-github-username/IoT-STH.git
```
...
```no-highlight
git remote add IoT-STH https://github.com/telefonicaid/IoT-STH.git
```
4. Synchronize the ```develop``` branch in your forked repository with the ```develop``` branch in the main IoT-STH repository:
<br/><br/>(step 4.1, just in case you were not in the ```develop``` branch yet) 
```
