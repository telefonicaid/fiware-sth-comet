...
const CollectionDataInferenceError = function(databaseName, collectionName) {
    Error.call(this);
...
const CollectionExistsError = function(databaseName, collectionName) {
    Error.call(this);
...
const NotExistentCollectionError = function(databaseName, collectionName) {
    Error.call(this);
    this.code = 'COLLECTION_EXISTS_ERROR';
    this.name = 'CollectionExistsError';
...
const NotSupportedMigration = function(databaseName, collectionName, originalDataModel, targetDataModel) {
    Error.call(this);
...
module.exports = {
    ...
    CollectionDataInferenceError,
    NotExistentCollectionError,
    NotSupportedMigration
};
