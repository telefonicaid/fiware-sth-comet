...
const STHWritableStream = function(databaseConnection, databaseName, collectionName, count) {
...
function getQuery(docId) {
    const query = {};
    const properties = Object.keys(docId._id);
