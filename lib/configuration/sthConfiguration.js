...
if (ENV.RECONNECT_TRIES && !isNaN(ENV.RECONNECT_TRIES) && parseInt(ENV.RECONNECT_TRIES, 10) > 0) {
    ...
    !isNaN(config.database.poolSize) &&
...
if (ENV.RECONNECT_INTERVAL && !isNaN(ENV.RECONNECT_INTERVAL) && parseInt(ENV.RECONNECT_INTERVAL, 10) > 0) {
    ...
    module.exports.RECONNECT_INTERVAL = parseInt(config.database.reconnectTries, 10);
    sthLogger.info(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Database reconnect interval set to value: ' + module.exports.RECONNECT_INTERVAL
    );
    ...
    sthLogger.warn(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Invalid or not configured reconnect interval size, setting to default value: ' +
