...
if (ENV.RECONNECT_TRIES && !isNaN(ENV.RECONNECT_TRIES) && parseInt(ENV.RECONNECT_TRIES, 10) > 0) {
    module.exports.RECONNECT_TRIES = parseInt(ENV.RECONNECT_TRIES, 10);
    sthLogger.info(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Database reconnect tries set to value: ' + module.exports.RECONNECT_TRIES
    );
} else if (
    ...
    module.exports.RECONNECT_TRIES = parseInt(config.database.reconnectTries, 10);
    sthLogger.info(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Database reconnect tries set to value: ' + module.exports.RECONNECT_TRIES
    );
} else {
    module.exports.RECONNECT_TRIES = 30;
    sthLogger.warn(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Invalid or not configured database reconnect tries, setting to default value: ' +
            module.exports.RECONNECT_TRIES
    );
}

if (ENV.RECONNECT_INTERVAL && !isNaN(ENV.RECONNECT_INTERVAL) && parseInt(ENV.RECONNECT_INTERVAL, 10) > 0) {
    module.exports.RECONNECT_INTERVAL = parseInt(ENV.RECONNECT_INTERVAL, 10);
    sthLogger.info(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Database reconnect interval set to value: ' + module.exports.RECONNECT_INTERVAL
    );
} else if (
    ...
    module.exports.RECONNECT_INTERVAL = parseInt(config.database.reconnectInterval, 10);
    sthLogger.info(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Database reconnect interval set to value: ' + module.exports.RECONNECT_INTERVAL
    );
} else {
    module.exports.RECONNECT_INTERVAL = 1000;
    sthLogger.warn(
        module.exports.LOGGING_CONTEXT.STARTUP,
        'Invalid or not configured database reconnect interval, setting to default value: ' +
            module.exports.RECONNECT_INTERVAL
    );
}
