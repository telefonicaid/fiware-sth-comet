...
function getContext(request) {
  return {
    corr: sthHelper.getCorrelator(request),
    trans: sthHelper.createTransaction(),
        ...
        if (err) {
          ...
          sthDatabase.getRawData(
            ...
            function (err, result) {
              ...
              if (sthHelper.getCorrelator(request)) {
                response.header(sthConfig.HEADER.CORRELATOR, sthHelper.getCorrelator(request));
              }
            }
          );
        }
