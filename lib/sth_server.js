...
function startServer(host, port, aSTHDatabase, callback) {
  ...
  /**
   * Handler called once the notification info has been generated
   ...
   * @param result The notification info in case no error ocurred
   */
  function onNotificationInfo(data, reply, err, result) {
