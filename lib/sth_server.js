...
function getContext(request) {
  return {
    corr: request.headers[sthConfig.HEADER.UNICA_CORRELATOR] ||
        ...
        if (err) {
          ...
          sthDatabase.getRawData(
            ...
            function (err, result) {
              ...
              if (request.headers[sthConfig.HEADER.UNICA_CORRELATOR]) {
                response.header(sthConfig.HEADER.UNICA_CORRELATOR, request.headers[sthConfig.HEADER.UNICA_CORRELATOR]);
              }
            }
          );
        }
