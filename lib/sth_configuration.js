...
module.exports.DEFAULT_SERVICE = ENV.DEFAULT_SERVICE || config.database.defaultService || 'testService';
if (!ENV.DEFAULT_SERVICE && !(config && config.database && config.database.defaultService)) {
  sthLogger.warn(
    module.exports.LOGGING_CONTEXT.STARTUP,
...
} else if (config && config.database && config.database.defaultServicePath &&
  config.database.defaultServicePath.charAt(0) === '/') {
    module.exports.DEFAULT_SERVICE_PATH = config.database.defaultServicePath;
    sthLogger.info(
      module.exports.LOGGING_CONTEXT.STARTUP,
      'Default service path set to value: ' + module.exports.DEFAULT_SERVICE_PATH
    );
...
if (ENV.SHOULD_HASH) {
  module.exports.SHOULD_HASH = (ENV.SHOULD_HASH.toLowerCase() === 'true');
  sthLogger.info(
    module.exports.LOGGING_CONTEXT.STARTUP,
    'Database should hash collection names set to value: ' + module.exports.SHOULD_HASH);
} else if (config && config.database && config.database.shouldHash) {
  module.exports.SHOULD_HASH = (config.database.shouldHash.toLowerCase === 'true');
  sthLogger.info(
    module.exports.LOGGING_CONTEXT.STARTUP,
    'Database should hash collection names set to value: ' + module.exports.SHOULD_HASH);
} else {
  ...
  sthLogger.warn(
    module.exports.LOGGING_CONTEXT.STARTUP,
    'Invalid or not configured database should hash collection names, setting to default value: ' +
      module.exports.SHOULD_HASH);
}

if (ENV.TRUNCATION_EXPIREAFTERSECONDS && !isNaN(ENV.TRUNCATION_EXPIREAFTERSECONDS) &&
  parseInt(ENV.TRUNCATION_EXPIREAFTERSECONDS, 10) >= 0) {
  module.exports.TRUNCATION_EXPIREAFTERSECONDS = parseInt(ENV.TRUNCATION_EXPIREAFTERSECONDS, 10);
  sthLogger.info(
    module.exports.LOGGING_CONTEXT.STARTUP,
    'Database truncation expiration time set to value: ' + module.exports.TRUNCATION_EXPIREAFTERSECONDS);
  ...
  module.exports.TRUNCATION_EXPIREAFTERSECONDS = parseInt(config.database.truncation.expireAfterSeconds, 10);
  sthLogger.info(
    module.exports.LOGGING_CONTEXT.STARTUP,
    'Database truncation expiration time set to value: ' + module.exports.TRUNCATION_EXPIREAFTERSECONDS);
} else {
  ...
  sthLogger.warn(
    ...
    'Invalid or not configured database truncation expiration time, setting to default value: ' +
      module.exports.TRUNCATION_EXPIREAFTERSECONDS);
}
...
if (ENV.DB_URI && ENV.DB_URI.split(':').length === 2 && !isNaN(ENV.DB_URI.split(':')[1])) {
   module.exports.DB_URI = ENV.DB_URI;
   sthLogger.info(
     module.exports.LOGGING_CONTEXT.STARTUP,
     'Database URI set to value: ' + module.exports.DB_URI);
} else if (config && config.database && config.database.URI && config.database.URI.split(':').length === 2 &&
  !isNaN(config.database.URI.split(':')[1])) {
    module.exports.DB_URI = config.database.URI;
    sthLogger.info(
      module.exports.LOGGING_CONTEXT.STARTUP,
      'Database URI set to value: ' + module.exports.DB_URI);
} else {
  module.exports.DB_URI = 'localhost:27017';
  sthLogger.warn(
    module.exports.LOGGING_CONTEXT.STARTUP,
