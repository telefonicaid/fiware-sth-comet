...
module.exports.AGGREGATE_BY = [];
if (config.server.aggregateBy && config.server.aggregateBy.length) {
  config.server.aggregateBy.forEach(function (entry) {
    if (module.exports.RESOLUTION[entry.toUpperCase()]) {
      module.exports.AGGREGATE_BY.push(entry);
    } else {
      sthLogger.warn(
...
if (module.exports.AGGREGATE_BY.length === 0) {
  sthLogger.warn(
    module.exports.LOGGING_CONTEXT.SERVER_START,
