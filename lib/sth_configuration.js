...
if (!isNaN(ENV.LOG_FILE_MAX_SIZE_IN_BYTES)) {
  module.exports.LOG_FILE_MAX_SIZE_IN_BYTES = parseInt(ENV.LOG_FILE_MAX_SIZE_IN_BYTES, 10);
} else if (!isNaN(config.logging.maxFileSize)) {
  module.exports.LOG_FILE_MAX_SIZE_IN_BYTES = parseInt(config.logging.maxFileSize, 10);
} else {
...
module.exports.LOG_FILE_NAME = ENV.LOG_FILE_NAME || config.logging.fileName || 'sth.log';
...
if (module.exports.AGGREGATION.length === 0) {
  sthLogger.warn('No valid aggregation configuration has been set. Nothing will be aggregated. ' +
