...
function generateNotificationInfo(data, searchResult, callback) {
  if (searchResult) {
    if (searchResult.attrValue !== data.attribute.value) {
    ...
    function (err, hashCollection) {
      ...
      hashCollection.findOne(
        ...
        function(err, result) {
          ...
          if (result && result.isAggregated === isAggregated &&
            result.service === service && result.servicePath === servicePath &&
            (entityId ? result.entityId === entityId : true) &&
            (entityType ? result.entityType === entityType : true) &&
            (attrName ? result.attrName === attrName : true)) {
...
/**
 * Removes the data associated to the attributes specified in the provided data in case of collection per
 ...
 * @param callback The callback to call with error or the result of the operation
 */
function removeDataIfCollection4ServicePath(data, options, callback) {
  var service = data.service,
      servicePath = data.servicePath,
      entityId = data.entityId,
      entityType = data.entityType,
  ...
  if (entityId || attrName) {
    ...
    var databaseName = getDatabase(service);
    ...
    database.collections(function (err, collections) {
      ...
      collections.forEach(function (collection) {
        ...
        } else if (collection.collectionName === collectionName) {
 ...
 * @param callback The callback to call with error or the result of the operation
 */
function removeDataIfCollection4Entity(data, options, callback) {
  var service = data.service,
      servicePath = data.servicePath,
      entityId = data.entityId,
      entityType = data.entityType,
 ...
 * @param callback The callback to call with error or the result of the operation
 */
function removeDataIfCollection4Attribute(data, options, callback) {
  var service = data.service,
      servicePath = data.servicePath,
      entityId = data.entityId,
      entityType = data.entityType,
...
function removeRawData(data, callback) {
  switch (DATA_MODEL) {
    case DATA_MODELS.COLLECTIONS_PER_SERVICE_PATH:
      removeDataIfCollection4ServicePath(data, {isAggregated: false}, callback);
      break;
    case DATA_MODELS.COLLECTIONS_PER_ENTITY:
      removeDataIfCollection4Entity(data, {isAggregated: false}, callback);
      break;
    case DATA_MODELS.COLLECTIONS_PER_ATTRIBUTE:
      removeDataIfCollection4Attribute(data, {isAggregated: false}, callback);
      break;
  }
}
...
function removeAggregatedData(data, callback) {
  switch (DATA_MODEL) {
    case DATA_MODELS.COLLECTIONS_PER_SERVICE_PATH:
      removeDataIfCollection4ServicePath(data, {isAggregated: true}, callback);
      break;
    case DATA_MODELS.COLLECTIONS_PER_ENTITY:
      removeDataIfCollection4Entity(data, {isAggregated: true}, callback);
      break;
    case DATA_MODELS.COLLECTIONS_PER_ATTRIBUTE:
      removeDataIfCollection4Attribute(data, {isAggregated: true}, callback);
      break;
  }
}
