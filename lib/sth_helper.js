...
/**
 * Returns the aggregation type based on an aggregation method
 * @param aggrMethod The aggregation method
 * @return {string} The aggregation type
 */
function getAggregationTypeFromMethod(aggrMethod) {
  if ([sthConfig.AGGREGATION.METHODS.SUM, sthConfig.AGGREGATION.METHODS.SUM2,
      sthConfig.AGGREGATION.METHODS.MIN, sthConfig.AGGREGATION.METHODS.MAX].indexOf(aggrMethod) !== -1) {
    return sthConfig.AGGREGATION.TYPES.NUMERIC;
  } else if (aggrMethod === 'occur') {
...
/**
 * Returns the aggregation type based on an attribute value
 * @param value The attribute value
 * @return {string} The aggregation type
 */
function getAggregationTypeFromValue(value) {
...
module.exports = {
  ...
  getAggregationTypeFromMethod: getAggregationTypeFromMethod,
  getAggregationTypeFromValue: getAggregationTypeFromValue
};
